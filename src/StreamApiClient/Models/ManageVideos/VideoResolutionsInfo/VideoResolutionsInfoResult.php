...
class VideoResolutionsInfoResult implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var VideoResolutionsInfoResult_data|null $data The resolutions info.
    */
    private ?VideoResolutionsInfoResult_data $data = null;
    ...
    */
    ...
    /**
     * Instantiates a new VideoResolutionsInfoResult and sets the default values.
    */
     ...
     * @return VideoResolutionsInfoResult
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideoResolutionsInfoResult {
        return new VideoResolutionsInfoResult();
    }
    ...
    */
    ...
    /**
     * Gets the data property value. The resolutions info.
     * @return VideoResolutionsInfoResult_data|null
    */
    public function getData(): ?VideoResolutionsInfoResult_data {
        return $this->data;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getObjectValue([VideoResolutionsInfoResult_data::class, 'createFromDiscriminatorValue'])),
    ...
    */
    ...
    /**
     * Sets the data property value. The resolutions info.
     * @param VideoResolutionsInfoResult_data|null $value Value to set for the data property.
    */
    public function setData(?VideoResolutionsInfoResult_data $value): void {
        $this->data = $value;
    }
