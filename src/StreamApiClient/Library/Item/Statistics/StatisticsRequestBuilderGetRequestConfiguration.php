...
class StatisticsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?DateTime $dateFrom = null, ?DateTime $dateTo = null, ?bool $hourly = null, ?string $videoGuid = null): StatisticsRequestBuilderGetQueryParameters {
        return new StatisticsRequestBuilderGetQueryParameters($dateFrom, $dateTo, $hourly, $videoGuid);
    }
