...
class VideosGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Video>|null $items The items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new VideosGetResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideosGetResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([Video::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Video>|null $value Value to set for the items property.
    */
