...
class AbusecaseGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<AbuseCase>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new AbusecaseGetResponse and sets the default values.
    */
     ...
     * @return AbusecaseGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AbusecaseGetResponse {
        return new AbusecaseGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([AbuseCase::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<AbuseCase>|null $value Value to set for the Items property.
    */
