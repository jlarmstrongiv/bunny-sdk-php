...
use BunnyApiClient\Models\ApiKeys\ListApiKeys\ApiKey;
use Microsoft\Kiota\Abstractions\Serialization\AdditionalDataHolder;
use Microsoft\Kiota\Abstractions\Serialization\Parsable;
use Microsoft\Kiota\Abstractions\Serialization\ParseNode;
use Microsoft\Kiota\Abstractions\Serialization\SerializationWriter;

class ApikeyGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ApiKey>|null $items The Items property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ApikeyGetResponse {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([ApiKey::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<ApiKey>|null $value Value to set for the Items property.
    */
