...
class PullZone implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $africaDiscount The Pull Zone specific pricing discount for Africa region.
    */
    private ?int $africaDiscount = null;
    ...
    */
    ...
    /**
     * @var int|null $asiaOceaniaDiscount The Pull Zone specific pricing discount for Asia & Oceania region.
    */
    private ?int $asiaOceaniaDiscount = null;
    ...
    */
    ...
    /**
     * @var float|null $cacheVersion The CacheVersion property
    */
    private ?float $cacheVersion = null;
    
    /**
     * @var string|null $cnameDomain The CNAME domain of the pull zone for setting up custom hostnames
    */
    private ?string $cnameDomain = null;
    ...
    */
    ...
    /**
     * @var int|null $dnsRecordId The ID of the DNS record tied to this pull zone
    */
    private ?int $dnsRecordId = null;
    
    /**
     * @var string|null $dnsRecordValue The cached version of the DNS record value
    */
    private ?string $dnsRecordValue = null;
    
    /**
     * @var int|null $dnsZoneId The ID of the DNS zone tied to this pull zone
    */
    private ?int $dnsZoneId = null;
    ...
    */
    ...
    /**
     * @var bool|null $enabled Determines if the Pull Zone is currently enabled, active and running
    */
    ...
    */
    ...
    /**
     * @var int|null $eUUSDiscount The Pull Zone specific pricing discount for EU and US region.
    */
    private ?int $eUUSDiscount = null;
    ...
    */
    ...
    /**
     * @var array<Hostname>|null $hostnames The list of hostnames linked to this Pull Zone
    */
    private ?array $hostnames = null;
    
    /**
     * @var int|null $id The unique ID of the pull zone.
    */
    private ?int $id = null;
    ...
    */
    ...
    /**
     * @var int|null $monthlyBandwidthUsed The amount of bandwidth in bytes that the pull zone used this month
    */
    private ?int $monthlyBandwidthUsed = null;
    ...
    */
    ...
    /**
     * @var float|null $optimizerPricing The OptimizerPricing property
    */
    private ?float $optimizerPricing = null;
    ...
    */
    ...
    /**
     * @var string|null $originLinkValue Returns the link short preview value for the pull zone origin connection.
    */
    private ?string $originLinkValue = null;
    ...
    */
    ...
    /**
     * @var float|null $priceOverride The custom price override for this zone
    */
    ...
    */
    ...
    /**
     * @var array<PullZone_RoutingFilters>|null $routingFilters The list of routing filters enabled for this zone
    */
    ...
    */
    ...
    /**
     * @var int|null $southAmericaDiscount The Pull Zone specific pricing discount for South America region.
    */
    private ?int $southAmericaDiscount = null;
    ...
    */
    ...
    /**
     * @var bool|null $suspended The Suspended property
    */
    ...
    */
    ...
    /**
     * @var int|null $videoLibraryId The ID of the video library that the zone is linked to
    */
    ...
    */
    ...
    /**
     * @var string|null $zoneSecurityKey The security key used for secure URL token authentication
    */
    private ?string $zoneSecurityKey = null;
    
    /**
     * Instantiates a new PullZone and sets the default values.
    */
     ...
     * @return PullZone
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullZone {
        return new PullZone();
    }
    ...
    */
    ...
    /**
     * Gets the AfricaDiscount property value. The Pull Zone specific pricing discount for Africa region.
     * @return int|null
    */
    public function getAfricaDiscount(): ?int {
        return $this->africaDiscount;
    }
    ...
    */
    ...
    /**
     * Gets the AsiaOceaniaDiscount property value. The Pull Zone specific pricing discount for Asia & Oceania region.
     * @return int|null
    */
    public function getAsiaOceaniaDiscount(): ?int {
        return $this->asiaOceaniaDiscount;
    }
    ...
    */
    ...
    /**
     * Gets the CacheVersion property value. The CacheVersion property
     * @return float|null
    */
    public function getCacheVersion(): ?float {
        return $this->cacheVersion;
    }

    /**
     * Gets the CnameDomain property value. The CNAME domain of the pull zone for setting up custom hostnames
     * @return string|null
    */
    public function getCnameDomain(): ?string {
    ...
    */
    ...
    /**
     * Gets the DnsRecordId property value. The ID of the DNS record tied to this pull zone
     * @return int|null
    */
    ...
    /**
     * Gets the DnsRecordValue property value. The cached version of the DNS record value
     * @return string|null
    */
    ...
    /**
     * Gets the DnsZoneId property value. The ID of the DNS zone tied to this pull zone
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Gets the Enabled property value. Determines if the Pull Zone is currently enabled, active and running
     * @return bool|null
    */
    ...
    */
    ...
    /**
     * Gets the EUUSDiscount property value. The Pull Zone specific pricing discount for EU and US region.
     * @return int|null
    */
    public function getEUUSDiscount(): ?int {
        return $this->eUUSDiscount;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'AfricaDiscount' => fn(ParseNode $n) => $o->setAfricaDiscount($n->getIntegerValue()),
            ...
            'AsiaOceaniaDiscount' => fn(ParseNode $n) => $o->setAsiaOceaniaDiscount($n->getIntegerValue()),
            ...
            'CacheVersion' => fn(ParseNode $n) => $o->setCacheVersion($n->getFloatValue()),
            'CnameDomain' => fn(ParseNode $n) => $o->setCnameDomain($n->getStringValue()),
            ...
            'DnsRecordId' => fn(ParseNode $n) => $o->setDnsRecordId($n->getIntegerValue()),
            'DnsRecordValue' => fn(ParseNode $n) => $o->setDnsRecordValue($n->getStringValue()),
            'DnsZoneId' => fn(ParseNode $n) => $o->setDnsZoneId($n->getIntegerValue()),
            ...
            'EUUSDiscount' => fn(ParseNode $n) => $o->setEUUSDiscount($n->getIntegerValue()),
            'FollowRedirects' => fn(ParseNode $n) => $o->setFollowRedirects($n->getBooleanValue()),
            'Hostnames' => fn(ParseNode $n) => $o->setHostnames($n->getCollectionOfObjectValues([Hostname::class, 'createFromDiscriminatorValue'])),
            ...
            'MonthlyBandwidthUsed' => fn(ParseNode $n) => $o->setMonthlyBandwidthUsed($n->getIntegerValue()),
            ...
            'OptimizerPricing' => fn(ParseNode $n) => $o->setOptimizerPricing($n->getFloatValue()),
            ...
            'OriginLinkValue' => fn(ParseNode $n) => $o->setOriginLinkValue($n->getStringValue()),
            ...
            'RoutingFilters' => fn(ParseNode $n) => $o->setRoutingFilters($n->getCollectionOfEnumValues(PullZone_RoutingFilters::class)),
            ...
            'SouthAmericaDiscount' => fn(ParseNode $n) => $o->setSouthAmericaDiscount($n->getIntegerValue()),
            ...
            'ZoneSecurityKey' => fn(ParseNode $n) => $o->setZoneSecurityKey($n->getStringValue()),
        ];
    }
    ...
    */
    ...
    /**
     * Gets the Hostnames property value. The list of hostnames linked to this Pull Zone
    ...
    */
    ...
    /**
     * Gets the Id property value. The unique ID of the pull zone.
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Gets the MonthlyBandwidthUsed property value. The amount of bandwidth in bytes that the pull zone used this month
     * @return int|null
    */
    public function getMonthlyBandwidthUsed(): ?int {
    ...
    */
     ...
     * @return float|null
    */
    public function getOptimizerPricing(): ?float {
    ...
    */
    ...
    /**
     * Gets the OriginLinkValue property value. Returns the link short preview value for the pull zone origin connection.
     * @return string|null
    */
    public function getOriginLinkValue(): ?string {
        return $this->originLinkValue;
    }
    ...
    */
    ...
    /**
     * Gets the PriceOverride property value. The custom price override for this zone
     * @return float|null
    */
    ...
    */
     ...
     * @return array<PullZone_RoutingFilters>|null
    */
    ...
    */
    ...
    /**
     * Gets the SouthAmericaDiscount property value. The Pull Zone specific pricing discount for South America region.
     * @return int|null
    */
    public function getSouthAmericaDiscount(): ?int {
    ...
    */
    ...
    /**
     * Gets the VideoLibraryId property value. The ID of the video library that the zone is linked to
     * @return int|null
    */
    ...
    */
    ...
    /**
     * Gets the ZoneSecurityKey property value. The security key used for secure URL token authentication
     * @return string|null
    */
    ...
    */
    ...
    /**
     * Sets the AfricaDiscount property value. The Pull Zone specific pricing discount for Africa region.
     * @param int|null $value Value to set for the AfricaDiscount property.
    */
    public function setAfricaDiscount(?int $value): void {
        $this->africaDiscount = $value;
    }
    ...
    */
    ...
    /**
     * Sets the AsiaOceaniaDiscount property value. The Pull Zone specific pricing discount for Asia & Oceania region.
     * @param int|null $value Value to set for the AsiaOceaniaDiscount property.
    */
    public function setAsiaOceaniaDiscount(?int $value): void {
        $this->asiaOceaniaDiscount = $value;
    }
    ...
    */
    ...
    /**
     * Sets the CacheVersion property value. The CacheVersion property
     * @param float|null $value Value to set for the CacheVersion property.
    */
    public function setCacheVersion(?float $value): void {
        $this->cacheVersion = $value;
    }

    /**
     * Sets the CnameDomain property value. The CNAME domain of the pull zone for setting up custom hostnames
     * @param string|null $value Value to set for the CnameDomain property.
    */
    public function setCnameDomain(?string $value): void {
        $this->cnameDomain = $value;
    }
    ...
    */
    ...
    /**
     * Sets the DnsRecordId property value. The ID of the DNS record tied to this pull zone
     * @param int|null $value Value to set for the DnsRecordId property.
    */
    public function setDnsRecordId(?int $value): void {
        $this->dnsRecordId = $value;
    }

    /**
     * Sets the DnsRecordValue property value. The cached version of the DNS record value
     * @param string|null $value Value to set for the DnsRecordValue property.
    */
    public function setDnsRecordValue(?string $value): void {
        $this->dnsRecordValue = $value;
    }

    /**
     * Sets the DnsZoneId property value. The ID of the DNS zone tied to this pull zone
     * @param int|null $value Value to set for the DnsZoneId property.
    */
    public function setDnsZoneId(?int $value): void {
    ...
    */
    ...
    /**
     * Sets the Enabled property value. Determines if the Pull Zone is currently enabled, active and running
    ...
    */
    ...
    /**
     * Sets the EUUSDiscount property value. The Pull Zone specific pricing discount for EU and US region.
     * @param int|null $value Value to set for the EUUSDiscount property.
    */
    public function setEUUSDiscount(?int $value): void {
        $this->eUUSDiscount = $value;
    }
    ...
    */
    ...
    /**
     * Sets the Hostnames property value. The list of hostnames linked to this Pull Zone
     * @param array<Hostname>|null $value Value to set for the Hostnames property.
    */
    ...
    /**
     * Sets the Id property value. The unique ID of the pull zone.
    ...
    */
    ...
    /**
     * Sets the MonthlyBandwidthUsed property value. The amount of bandwidth in bytes that the pull zone used this month
     * @param int|null $value Value to set for the MonthlyBandwidthUsed property.
    */
    public function setMonthlyBandwidthUsed(?int $value): void {
    ...
    */
     ...
     * @param float|null $value Value to set for the OptimizerPricing property.
    */
    public function setOptimizerPricing(?float $value): void {
    ...
    */
    ...
    /**
     * Sets the OriginLinkValue property value. Returns the link short preview value for the pull zone origin connection.
     * @param string|null $value Value to set for the OriginLinkValue property.
    */
    public function setOriginLinkValue(?string $value): void {
        $this->originLinkValue = $value;
    }
    ...
    */
    ...
    /**
     * Sets the PriceOverride property value. The custom price override for this zone
    ...
    */
     ...
     * @param array<PullZone_RoutingFilters>|null $value Value to set for the RoutingFilters property.
    */
    ...
    */
    ...
    /**
     * Sets the SouthAmericaDiscount property value. The Pull Zone specific pricing discount for South America region.
     * @param int|null $value Value to set for the SouthAmericaDiscount property.
    */
    public function setSouthAmericaDiscount(?int $value): void {
    ...
    */
    ...
    /**
     * Sets the VideoLibraryId property value. The ID of the video library that the zone is linked to
    ...
    */
    ...
    /**
     * Sets the ZoneSecurityKey property value. The security key used for secure URL token authentication
     * @param string|null $value Value to set for the ZoneSecurityKey property.
    */
    public function setZoneSecurityKey(?string $value): void {
        $this->zoneSecurityKey = $value;
    }
