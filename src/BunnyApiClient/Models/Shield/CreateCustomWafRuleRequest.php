...
class CreateCustomWafRuleRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateCustomWafRuleRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateCustomWafRuleRequest {
