...
class CreateWafRateLimitRuleModel_variableTypes implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateWafRateLimitRuleModel_variableTypes and sets the default values.
    */
     ...
     * @return CreateWafRateLimitRuleModel_variableTypes
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateWafRateLimitRuleModel_variableTypes {
        return new CreateWafRateLimitRuleModel_variableTypes();
    }
