...
class UpdateWafRateLimitRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UpdateWafRateLimitRequest and sets the default values.
    */
     ...
     * @return UpdateWafRateLimitRequest
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateWafRateLimitRequest {
