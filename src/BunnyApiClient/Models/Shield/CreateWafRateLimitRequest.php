...
class CreateWafRateLimitRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CreateWafRateLimitRuleModel|null $ruleConfiguration The ruleConfiguration property
    */
    private ?CreateWafRateLimitRuleModel $ruleConfiguration = null;
    ...
    */
    ...
    /**
     * Instantiates a new CreateWafRateLimitRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateWafRateLimitRequest {
        return new CreateWafRateLimitRequest();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'ruleConfiguration' => fn(ParseNode $n) => $o->setRuleConfiguration($n->getObjectValue([CreateWafRateLimitRuleModel::class, 'createFromDiscriminatorValue'])),
     ...
     * @return CreateWafRateLimitRuleModel|null
    */
    public function getRuleConfiguration(): ?CreateWafRateLimitRuleModel {
    ...
    */
     ...
     * @param CreateWafRateLimitRuleModel|null $value Value to set for the ruleConfiguration property.
    */
    public function setRuleConfiguration(?CreateWafRateLimitRuleModel $value): void {
