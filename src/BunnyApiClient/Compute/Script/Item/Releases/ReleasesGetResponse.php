...
use BunnyApiClient\Models\Compute\ScriptRelease;
use Microsoft\Kiota\Abstractions\Serialization\AdditionalDataHolder;
use Microsoft\Kiota\Abstractions\Serialization\Parsable;
use Microsoft\Kiota\Abstractions\Serialization\ParseNode;
use Microsoft\Kiota\Abstractions\Serialization\SerializationWriter;

class ReleasesGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<ScriptRelease>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new ReleasesGetResponse and sets the default values.
    */
     ...
     * @return ReleasesGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ReleasesGetResponse {
        return new ReleasesGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([ScriptRelease::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return array<ScriptRelease>|null
    */
    ...
    */
     ...
     * @param array<ScriptRelease>|null $value Value to set for the Items property.
    */
