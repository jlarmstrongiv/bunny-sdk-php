...
class VideolibraryGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<VideoLibrary>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new VideolibraryGetResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideolibraryGetResponse {
        return new VideolibraryGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([VideoLibrary::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return array<VideoLibrary>|null
    */
    ...
    */
     ...
     * @param array<VideoLibrary>|null $value Value to set for the Items property.
    */
