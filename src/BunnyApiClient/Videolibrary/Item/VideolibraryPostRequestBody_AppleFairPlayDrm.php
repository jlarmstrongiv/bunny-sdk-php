...
class VideolibraryPostRequestBody_AppleFairPlayDrm implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VideolibraryPostRequestBody_AppleFairPlayDrm and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideolibraryPostRequestBody_AppleFairPlayDrm {
        return new VideolibraryPostRequestBody_AppleFairPlayDrm();
    }
