...
use BunnyApiClient\Models\StreamVideoLibrary\GetLanguages\Language;
use Exception;
...
class LanguagesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/videolibrary/languages');
     ...
     * @return Promise<array<Language>|null>
     * @throws Exception
    */
    public function get(?LanguagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendCollectionAsync($requestInfo, [Language::class, 'createFromDiscriminatorValue'], null);
    }
