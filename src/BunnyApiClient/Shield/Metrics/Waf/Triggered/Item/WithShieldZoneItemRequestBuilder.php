...
/**
 * Builds and executes requests for operations under /shield/metrics/waf/triggered/{shieldZoneId}
*/
class WithShieldZoneItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/shield/metrics/waf/triggered/{shieldZoneId}{?dataTimeframe,groupTime}');
