...
use BunnyApiClient\Models\Shield\WafRuleMainGroupModel;
use Exception;
...
class RulesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/shield/waf/rules');
     ...
     * @return Promise<array<WafRuleMainGroupModel>|null>
     * @throws Exception
    */
    public function get(?RulesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendCollectionAsync($requestInfo, [WafRuleMainGroupModel::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
