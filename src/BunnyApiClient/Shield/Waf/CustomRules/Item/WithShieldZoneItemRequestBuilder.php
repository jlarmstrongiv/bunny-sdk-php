...
use BunnyApiClient\Models\Shield\GetCustomWafRulesResponse;
...
class WithShieldZoneItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/shield/waf/custom-rules/{shieldZoneId}{?page,perPage}');
     ...
     * @return Promise<GetCustomWafRulesResponse|null>
     * @throws Exception
    */
    public function get(?WithShieldZoneItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [GetCustomWafRulesResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
