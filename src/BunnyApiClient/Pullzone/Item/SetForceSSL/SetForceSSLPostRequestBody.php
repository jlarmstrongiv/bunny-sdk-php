...
class SetForceSSLPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $forceSSL Set to true to force SSL on the given pull zone hostname
    */
    private ?bool $forceSSL = null;
    
    /**
     * @var string|null $hostname The hostname that will be updated
    */
    private ?string $hostname = null;
    
    /**
     * Instantiates a new SetForceSSLPostRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SetForceSSLPostRequestBody {
