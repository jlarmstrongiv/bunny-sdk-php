...
class RemoveCertificateDeleteRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $hostname The hostname from which the certificate will be removed
    */
    private ?string $hostname = null;
    
    /**
     * Instantiates a new RemoveCertificateDeleteRequestBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RemoveCertificateDeleteRequestBody {
