...
class PullzoneGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<PullZone>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new PullzoneGetResponse and sets the default values.
    */
     ...
     * @return PullzoneGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullzoneGetResponse {
        return new PullzoneGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([PullZone::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<PullZone>|null $value Value to set for the Items property.
    */
