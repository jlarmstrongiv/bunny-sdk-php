...
class RecordsPutRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<RecordsPutRequestBody_EnviromentalVariables>|null $enviromentalVariables The EnviromentalVariables property
    */
    ...
    */
    ...
    /**
     * Instantiates a new RecordsPutRequestBody and sets the default values.
    */
     ...
     * @return RecordsPutRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): RecordsPutRequestBody {
        return new RecordsPutRequestBody();
    }
    ...
    */
     ...
     * @return array<RecordsPutRequestBody_EnviromentalVariables>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'EnviromentalVariables' => fn(ParseNode $n) => $o->setEnviromentalVariables($n->getCollectionOfObjectValues([RecordsPutRequestBody_EnviromentalVariables::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<RecordsPutRequestBody_EnviromentalVariables>|null $value Value to set for the EnviromentalVariables property.
    */
