...
class StoragezoneGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<StorageZone>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new StoragezoneGetResponse and sets the default values.
    */
     ...
     * @return StoragezoneGetResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): StoragezoneGetResponse {
        return new StoragezoneGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([StorageZone::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<StorageZone>|null $value Value to set for the Items property.
    */
