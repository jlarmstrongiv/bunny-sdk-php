...
use BunnyApiClient\Models\StorageZone\GetStorageZoneConnections\Connection;
use Exception;
...
class ConnectionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/storagezone/{id}/connections');
     ...
     * @return Promise<array<Connection>|null>
     * @throws Exception
    */
    public function get(?ConnectionsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendCollectionAsync($requestInfo, [Connection::class, 'createFromDiscriminatorValue'], null);
    }
