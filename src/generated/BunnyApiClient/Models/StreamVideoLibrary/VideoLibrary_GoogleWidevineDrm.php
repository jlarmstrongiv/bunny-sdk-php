...
class VideoLibrary_GoogleWidevineDrm implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VideoLibrary_GoogleWidevineDrm and sets the default values.
    */
     ...
     * @return VideoLibrary_GoogleWidevineDrm
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideoLibrary_GoogleWidevineDrm {
        return new VideoLibrary_GoogleWidevineDrm();
    }
