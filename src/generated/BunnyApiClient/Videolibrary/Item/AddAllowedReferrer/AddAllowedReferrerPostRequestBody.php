...
class AddAllowedReferrerPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $hostname The hostname that will be added as an allowed referer
    */
    private ?string $hostname = null;
    
    /**
     * Instantiates a new AddAllowedReferrerPostRequestBody and sets the default values.
    */
     ...
     * @return AddAllowedReferrerPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AddAllowedReferrerPostRequestBody {
