...
class ScriptGetResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Script>|null $items The Items property
    */
    ...
    */
    ...
    /**
     * Instantiates a new ScriptGetResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ScriptGetResponse {
        return new ScriptGetResponse();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'Items' => fn(ParseNode $n) => $o->setItems($n->getCollectionOfObjectValues([Script::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Script>|null $value Value to set for the Items property.
    */
