...
use BunnyApiClient\Models\Statistics\GetStatistics\Statistics;
use Exception;
...
class StatisticsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/statistics{?dateFrom*,dateTo*,hourly*,loadErrors*,pullZone*,serverZoneId*}');
    ...
    */
    public function get(?StatisticsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [Statistics::class, 'createFromDiscriminatorValue'], null);
    }
