...
class Moment implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $label The text description label for the chapter
    */
    private ?string $label = null;
    
    /**
     * @var int|null $timestamp The timestamp of the moment in seconds
    */
    private ?int $timestamp = null;
    
    /**
     * Instantiates a new Moment and sets the default values.
    */
     ...
     * @return Moment
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Moment {
        return new Moment();
    }
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'timestamp' => fn(ParseNode $n) => $o->setTimestamp($n->getIntegerValue()),
        ];
    }
    ...
    */
     ...
     * @param int|null $value Value to set for the timestamp property.
    */
