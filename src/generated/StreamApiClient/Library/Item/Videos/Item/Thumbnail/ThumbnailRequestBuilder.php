...
class ThumbnailRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/library/{libraryId}/videos/{videoId}/thumbnail?thumbnailUrl={thumbnailUrl}');
     ...
     * @throws Exception
    */
    public function post(?ThumbnailRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(?ThumbnailRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
